...
* **Raw data** :  Database of SERS bile acid spectra that were used (Raw and Preprocess form) in the article submitted by *Lebrun and Boudreau (2022)*(doi: 10.1177/00037028221077119) can be used as a starting point to start using the BoxSERS package.
