...
```
![alt text](https://github.com/ALebrun-108/Advanced-processing-and-machine-learning-for-vibrational-spectra/blob/master/train_distribution_plot.png?raw=true)
### Data Augmentation
